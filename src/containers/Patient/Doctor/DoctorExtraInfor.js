...
class DoctorExtraInfor extends Component {
    ...
    //  console.log('check state: ',this.state)
        ...
        return (
    <div className='doctor-extra-infor-containter'>
    ...
    <div className='content-down'> 
            ...
            ? 
                <div className='detail-price'> <FormattedMessage id="patient.extra-infor.price" /> 
            ...
            :
                ...
                <div className='detail-infor'>
                    <div className='price'>
                        <div>
                            <span className='left'>
                            <FormattedMessage id="patient.extra-infor.detail-price" />
                            </span>
