                ...
                <div className='containter'>
                    ...
                    <div className='col-12 my-3'>
                        ...
                        <div className="col-3">
                            ...
                            <input type="text" className="form-control" id="inputAddress2" placeholder="Last Name"
                                value={lastname}
                                onChange= {(event) => {this.onChangeInput(event, 'lastname')}}
                            />
                        </div>
                        <div className="col-3">
                            <label for="inputAddress2"><FormattedMessage id="manage-user.phone"/></label>
                            <input type="text" className="form-control" id="inputAddress2" placeholder="Phone Number"
                                value={phonenumber}
                        ...
                        <div className="col-3">
                            <label for="inputAddress2"><FormattedMessage id="manage-user.gender"/></label>
                        ...
                        <div className="col-3">
                            <label for="inputAddress2"><FormattedMessage id="manage-user.position"/></label>
                            <select className="form-control"
                        ...
                        <div className="col-3">
                            <label for="inputAddress2"><FormattedMessage id="manage-user.role"/></label>
                            <select className="form-control"
                        ...
                        <div className='col-12 my-3'>
                <button type="submit" className={this.state.action === CRUD_ACTIONS.EDIT ? "btn btn-success" : "btn btn-primary"}
...
const mapDispatchToProps = dispatch => {
    return {
      ...
      //  processLogout: () => dispatch(actions.processLogout()),
       // changeLapguageAppRedux: (language) => dispatch(actions.changeLapguageApp(language))
    };
};
